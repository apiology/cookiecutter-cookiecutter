...
description: >-
  Sync boilerplate for this cookiecutter template (cookiecutter-cookiecutter,
  Cookiecutter) from reference repos using only origin/main;
...
**This template:** `cookiecutter-cookiecutter` — Cookiecutter cookiecutter.
...
- Port from reference repos only what fits **this** tier (Cookiecutter).
...
|------|--------------|--------|
| Meta | `cookiecutter-cookiecutter` | Bakes child templates; sync docs live under baked `cookiecutter-cookiecutter/` |
| Language/tool | `cookiecutter-ruby` | Cookiecutter boilerplate |
...
- Cookiecutter vars: `cookiecutter-cookiecutter`, `Cookiecutter`
